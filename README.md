...
Money was invented to serve three main functions: store value, facilitate exchange, and serve as a unit of account. Outside of a few majors, the majority of currencies have failed to deliver on the first two promises due to inadequate governance. NUMO serves as a solution by achieving all three promises without being subject to the whims of any single government or political headwinds. Thus fufilling a fourth promise, the seperation between money and state.
